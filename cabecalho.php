...
$autor = '<a href="https://www.linkedin.com/in/vinicius-fernandes-andrade/" target="_blank" style="color:#bebebe">Vinicius</a>';
...
<nav class="navbar">
    ...
    <a href="./certificado"> <i class="fas fa-angle-right"></i> Certificado </a> <br>
    ...
    <a href="./equipe"> <i class="fas fa-angle-right"></i> Equipe </a>
    '.$sair.'
</nav>';
