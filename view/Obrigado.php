...
<head>
    ...
    <title>SMDI 2025 - Inscrição Concluída</title>
            ...
            <div class="row justify-content-md-center">
                <div class="card shadow-lg thank-you-card">
                    <div class="card-body text-center">
                            ...
                            <h1 class="card-title h3 mb-3">Inscrição Realizada com Sucesso!</h1>
                            <p class="card-text lead"></p>
                                <p class="text-muted small">Referência da sua inscrição: <?php $feedback = $_SESSION['form_feedback']; echo $feedback['pids'][0]; ?></p>
                            <p class="mt-4">
                                Agradecemos seu interesse no SMDI 2025. Você receberá um e-mail com os próximos passos e informações sobre o pagamento.
                            </p>
                            <hr class="my-4">
